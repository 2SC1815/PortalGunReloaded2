...
public class AerialFaithPlate extends TestingElement {
	...
	public AerialFaithPlate(Location OriginLoc, int x, int y, int z, float yaw, float pitch, int power) {
		super(OriginLoc, com.murabi10.portalgunreloaded2.testingelement.ElementType.AERIAL_FAITH_PLATE,
				com.murabi10.portalgunreloaded2.testingelement.LinkType.DNC, org.bukkit.block.BlockFace.SOUTH, x, y, z);
		this.Yaw = yaw;
		this.Pitch = pitch;
		this.power = power;
	}
