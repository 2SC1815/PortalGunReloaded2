...
public class XOR extends TestingElement {

	protected XOR(Location OriginLoc, int x, int y, int z) {
		super(OriginLoc, ElementType.XOR, LinkType.OUT_IN, BlockFace.SOUTH, x, y, z);
	}
