...
public class Timer extends TestingElement {
	...
	public Timer(Location OriginLoc, int x, int y, int z) {
		super(OriginLoc, ElementType.TIMER, com.murabi10.portalgunreloaded2.testingelement.LinkType.OUT_IN,
	...
	protected void Run() {
		...
		if ((isInput() != this.oldActivated) && (isInput())) {
			...
			this.timerRunnable.runTaskTimer(com.murabi10.portalgunreloaded2.PortalGun.getPlugin(), 0L, 20L);
		}
